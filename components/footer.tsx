...
export function Footer() {
  return <footer className="footer reference-footer">
    <div className="container footer-grid">
      ...
      <div><h3>Explore</h3><Link href="/products">Products</Link><Link href="/solutions">Solutions</Link><Link href="/cases">Case Studies</Link><Link href="/project-support">Project Support</Link><Link href="/source/blog">Blog</Link><Link href="/about">About</Link></div>
